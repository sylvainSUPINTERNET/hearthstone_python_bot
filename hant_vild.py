...
def hero_strength(template):  # функция силы героя hant
    global zero, activity, screen_width_x, screen_height_y
    try:
...
def hod_1():
    print(active_dir + 'btn_strela.png')
...
def hod_2():
    ...
    for card in card_position:
        ...
        for two in two_mana_h:  # перебираем все карты за 2 маны
            print(active_dir + 'carts/' + str(two))
            time.sleep(0.1)
            karta(active_dir + 'carts/' + str(two))
            if unit == 1:
                pointclick()
                break
...
def hod_6():
    ...
    for card in card_position:
        ...
        if unit == 0:
            for fore in fore_mana_h:  # перебираем все карты за 2 маны
                time.sleep(0.1)
                karta(active_dir + 'carts/' + str(fore))
                if unit == 1:
                    pointclick()
                    hero_strength(active_dir + 'btn_strela.png')
                    pointclick()
...
two_mana_h = dict.fromkeys(['02_bear_lov.png', '02_drotik_lov.png', '02_faz_hant.png', '02_fokus_lov.png',
                            '02_jad_lov.png', '02_kletka_lov.png', '02_krysa_lov.png', '02_led_lov.png',
                            '02_moroz_lov.png', '02_napravl_lov.png', '02_plennyj.png', '02_plita_lov.png',
                            '02_sniper.png', '02_sniper_lov.png', '02_taktika_lov.png', '02_vzruv_lov.png'], 2)
fore_mana_h = dict.fromkeys(['04_dragon.png', '04_merzocid.png'], 4)
six_mana_h = dict.fromkeys(['06_genn.png', '06_genn.png'], 6)
...
def hant_vild_deck():
    ...
    ss(active_dir + "btn_left.png")  # переходим в левое окно с колодами
    ss(active_dir + "hant_vild.png")  # вабираем колоду вольного воина
    ...
    if Ggame == 1:
        Ngame += 1
        #print("Игра hant началась", Gcikl)
